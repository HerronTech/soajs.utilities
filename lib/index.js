            ...
            if (args && args.length > 2) {
                ...
                fs.stat(profilesFolder, function (err, stats) {
                    ...
                    fs.stat(args[2], function (err, stats) {
                        ...
                        if (tmpConfig.designatedPort && tmpConfig.serviceName) {
                            ...
                            for (var i = 0; i < config.dockerfile_tpl.body.length; i++) {
                                ...
                                str = str.replace(/#SERVICEPORT#/g, tmpConfig.designatedPort);
                                wstream.write(str + "\n");
                            }
                            wstream.end();
                            var label = "";
                            ...
                            console.log("You need to have designatedPort as well as serviceName in [" + args[2] + "/config.js]");
                    });
                });
            }
            else
