...
module.exports = {
    ...
    "soajs_dockerfile_tpl" : {
        ...
        "maintainer": 'MAINTAINER SOAJS Team <team@soajs.com>',
        "body": [
            'RUN apt-get update && apt-get install -y nodejs npm && ln -s /usr/bin/nodejs /usr/bin/node && mkdir -p /opt/soajs/node_modules && mkdir -p /opt/soajs/log && mkdir -p /opt/soajs/FILES && mkdir /opt/node_modules',
