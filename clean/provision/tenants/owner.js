'use strict';
var dashboard_domain = "dashboard.soajs.org";
var dsbrd = {
					...
					"config": {
						"dashboard": {
							...
							"urac": {
								...
								"link": {
									"addUser": "http://" + dashboard_domain + "/#/setNewPassword",
									"changeEmail": "http://" + dashboard_domain + "/#/changeEmail/validate",
									"forgotPassword": "http://" + dashboard_domain + "/#/resetPassword",
									"join": "http://" + dashboard_domain + "/#/join/validate"
								},
